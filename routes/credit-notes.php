...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/credit-notes/search/invoices', [CreditNotesController::class, 'searchInvoices'])->middleware('module.permission:credit-notes,view')->name('credit-notes.search.invoices');
    Route::get('/credit-notes/search/products', [CreditNotesController::class, 'searchProducts'])->middleware('module.permission:credit-notes,view')->name('credit-notes.search.products');
