...
import { Plus, Edit, Trash2, Eye, BookOpen } from 'lucide-vue-next';
            ...
            <div v-else class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr v-for="account in props.accounts" :key="account.id" class="hover:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    <Link
                                        :href="administration.chartOfAccounts.show(account.id).url"
