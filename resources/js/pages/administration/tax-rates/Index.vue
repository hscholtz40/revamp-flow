            ...
            <div v-else class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr v-for="taxRate in props.taxRates" :key="taxRate.id" class="hover:bg-gray-50">
                            <td class="whitespace-nowrap px-6 py-4">
                                <div class="flex items-center">
                                    <Percent class="mr-2 h-5 w-5 text-gray-400" />
                                    <div>
                                        <div class="font-medium text-gray-900">{{ taxRate.name }}</div>
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    <Link
                                        :href="administration.taxRates.show(taxRate.id).url"
