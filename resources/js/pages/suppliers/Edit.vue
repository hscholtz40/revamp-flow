...
onMounted(() => {
    ...
    form.state = props.supplier.state || '';
    form.postal_code = props.supplier.postal_code || '';
    form.country = props.supplier.country || '';
    form.vat_number = props.supplier.vat_number || '';
    form.bank_name = props.supplier.bank_name || '';
    form.bank_account_name = props.supplier.bank_account_name || '';
    form.bank_account_number = props.supplier.bank_account_number || '';
    form.bank_sort_code = props.supplier.bank_sort_code || '';
...
<template>
    <Head :title="`Edit ${props.supplier.name}`" />
    <AppLayout :breadcrumbs="[
        { title: 'Suppliers', href: suppliers.index().url },
        { title: props.supplier.name, href: suppliers.show(props.supplier.id).url },
        { title: 'Edit', href: '#' }
    ]">
        <div class="p-6">
            <div class="mb-6">
                <Link
                    :href="suppliers.show(props.supplier.id).url"
