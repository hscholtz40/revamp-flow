                                ...
                                <div class="md:col-span-2 relative">
                                    ...
                                    <div class="relative">
                                        <input 
                                            ...
                                            :disabled="!canEdit"
                                        />
                                        <svg v-if="item.product_id && canEdit" @click="clearProduct(index)" class="absolute right-2 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 hover:text-gray-600 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                        </svg>
