...
const entityType = ref(props.template.entity_type);
const selectedColumns = ref<string[]>([...props.template.config.columns]);
        ...
        <div class="p-4">
            ...
            <div class="flex items-center justify-between gap-3 mb-6">
                ...
                <div class="flex items-center gap-2">
                    <Link
                        href="/reports"
                        class="rounded border px-4 py-2 hover:bg-gray-50 flex items-center gap-2"
                    >
                        <X class="w-4 h-4" />
                        Cancel
                    </Link>
