...
class GroupSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $modules = ['customers', 'users', 'groups', 'contacts', 'products', 'suppliers', 'stock-movements', 'purchase-orders', 'delivery-notes', 'jobcards', 'quotes', 'invoices', 'credit-notes', 'timesheet', 'messages', 'dispatch', 'tasks', 'queries', 'registered-users', 'customer-update-requests'];
