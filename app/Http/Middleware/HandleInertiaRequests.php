        ...
        return [
            ...
            'auth' => [
                ...
                'abilities' => $request->user() ? [
                    ...
                    'suppliers' => [
                        'list' => $request->user()->hasModulePermission('suppliers', 'list'),
                        'view' => $request->user()->hasModulePermission('suppliers', 'view'),
                        'create' => $request->user()->hasModulePermission('suppliers', 'create'),
                        'edit' => $request->user()->hasModulePermission('suppliers', 'edit'),
                        'delete' => $request->user()->hasModulePermission('suppliers', 'delete'),
                    ],
                    'stock-movements' => [
                        'list' => $request->user()->hasModulePermission('stock-movements', 'list'),
                        'view' => $request->user()->hasModulePermission('stock-movements', 'view'),
                        'create' => $request->user()->hasModulePermission('stock-movements', 'create'),
                        'edit' => $request->user()->hasModulePermission('stock-movements', 'edit'),
                        'delete' => $request->user()->hasModulePermission('stock-movements', 'delete'),
                    ],
                    'purchase-orders' => [
                        'list' => $request->user()->hasModulePermission('purchase-orders', 'list'),
                        'view' => $request->user()->hasModulePermission('purchase-orders', 'view'),
                        'create' => $request->user()->hasModulePermission('purchase-orders', 'create'),
                        'edit' => $request->user()->hasModulePermission('purchase-orders', 'edit'),
                        'delete' => $request->user()->hasModulePermission('purchase-orders', 'delete'),
                    ],
                ] : null,
            ],
